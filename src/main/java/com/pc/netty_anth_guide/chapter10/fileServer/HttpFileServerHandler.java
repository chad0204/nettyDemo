package com.pc.netty_anth_guide.chapter10.fileServer;
...
public class HttpFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
        ...
        sendFileFuture.addListener(new ChannelProgressiveFutureListener() {
            ...
            public void operationProgressed(ChannelProgressiveFuture channelProgressiveFuture, long progress, long total) throws Exception {
                if(total<0) {
                    ...
                    System.out.println("Transfer progress: "+path+"/"+total);
                }
            }
    ...
    private void sendError(ChannelHandlerContext ctx, HttpResponseStatus badRequest) {
        FullHttpResponse response = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1,badRequest,Unpooled.copiedBuffer(
                "Failure: "+badRequest.toString()+"/r/n",CharsetUtil.UTF_8));
